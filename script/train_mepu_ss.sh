python tools/gen_pseudo_label_new.py --proposal_path proposals/proposals_selective_search.json \
	--data_path datasets/sowod --save_path datasets/sowod/Annotations/pseudo_label_ss.json \
...
python train_net.py --eval-only --inference-rew --resume --dist-url auto --num-gpus 4 \
	...
	DATASETS.TEST \(\"sowod_train_t1_ss\",\) \
    OPENSET.OUTPUT_PATH_REW datasets/sowod/Annotations/pseudo_label_ss.json \

python train_net.py --resume --dist-url auto --num-gpus 4 --config config/MEPU-SOWOD/t1/train.yaml \
	DATASETS.TRAIN \(\"sowod_train_t1_ss\",\) \
    OUTPUT_DIR training_dir/mepu-sowod/ss-t1-train  OPENSET.REW.GAMMA 4.0 \

python train_net.py --resume --eval-only --dist-url auto --num-gpus 4 --config config/MEPU-SOWOD/t1/self-train.yaml \
	DATASETS.TEST \(\"sowod_train_t1\",\) OUTPUT_DIR training_dir/mepu-sowod/ss-t1-self-train OPENSET.OLN_INFERENCE True \
	OPENSET.INFERENCE_SELT_TRAIN True MODEL.WEIGHTS training_dir/mepu-sowod/ss-t1-train/model_final.pth  \

python tools/gen_pseudo_label_new.py --proposal_path training_dir/mepu-sowod/ss-t1-self-train/inference/inference_results.json \
...
python train_net.py --resume --dist-url auto --num-gpus 4 --config config/MEPU-SOWOD/t1/self-train.yaml \
	OUTPUT_DIR training_dir/mepu-sowod/ss-t1-self-train OPENSET.REW.GAMMA 4.0 \
	MODEL.WEIGHTS training_dir/mepu-sowod/ss-t1-train/model_final.pth \
...
python train_net.py --resume --eval-only --dist-url auto --num-gpus 4 --config config/MEPU-SOWOD/t2/train.yaml \
	DATASETS.TEST \(\"sowod_t2_train_and_ft\",\) OUTPUT_DIR training_dir/mepu-sowod/ss-t2-train OPENSET.OLN_INFERENCE True \
	OPENSET.INFERENCE_SELT_TRAIN True MODEL.WEIGHTS training_dir/mepu-sowod/ss-t1-self-train/model_final.pth  \

python tools/gen_pseudo_label_new.py --proposal_path training_dir/mepu-sowod/ss-t2-train/inference/inference_results.json \
	--data_path datasets/sowod --save_path datasets/sowod/Annotations/pseudo_label_st.json \
...
python train_net.py --resume --dist-url auto --num-gpus 4 --config config/MEPU-SOWOD/t2/train.yaml \
	OUTPUT_DIR training_dir/mepu-sowod/ss-t2-train OPENSET.REW.GAMMA 4.0 \
	MODEL.WEIGHTS training_dir/mepu-sowod/ss-t1-self-train/model_final.pth \

python train_net.py --resume --dist-url auto --num-gpus 4 --config config/MEPU-SOWOD/t2/ft.yaml \
	OUTPUT_DIR training_dir/mepu-sowod/ss-t2-ft OPENSET.REW.GAMMA 4.0 \
	MODEL.WEIGHTS training_dir/mepu-sowod/ss-t2-train/model_final.pth \
...
python train_net.py --resume --eval-only --dist-url auto --num-gpus 4 --config config/MEPU-SOWOD/t3/train.yaml \
	DATASETS.TEST \(\"sowod_t3_train_and_ft\",\) OUTPUT_DIR training_dir/mepu-sowod/ss-t3-train OPENSET.OLN_INFERENCE True \
	OPENSET.INFERENCE_SELT_TRAIN True MODEL.WEIGHTS training_dir/mepu-sowod/ss-t2-ft/model_final.pth  \

python tools/gen_pseudo_label_new.py --proposal_path training_dir/mepu-sowod/ss-t3-train/inference/inference_results.json \
    --data_path datasets/sowod --save_path datasets/sowod/Annotations/pseudo_label_st.json \
...
python train_net.py --resume --dist-url auto --num-gpus 4 --config config/MEPU-SOWOD/t3/train.yaml \
	OUTPUT_DIR training_dir/mepu-sowod/ss-t3-train OPENSET.REW.GAMMA 4.0 \
	MODEL.WEIGHTS training_dir/mepu-sowod/ss-t2-ft/model_final.pth \

python train_net.py --resume --dist-url auto --num-gpus 4 --config config/MEPU-SOWOD/t3/ft.yaml \
	OUTPUT_DIR training_dir/mepu-sowod/ss-t3-tf OPENSET.REW.GAMMA 4.0 \
	MODEL.WEIGHTS training_dir/mepu-sowod/ss-t3-train/model_final.pth \

# Task 4

python train_net.py --resume --dist-url auto --num-gpus 4 --config config/MEPU-SOWOD/t4/train.yaml \
	OUTPUT_DIR training_dir/mepu-sowod/ss-t4-train \
	MODEL.WEIGHTS training_dir/mepu-sowod/ss-t3-ft/model_final.pth \

python train_net.py --resume --dist-url auto --num-gpus 4 --config config/MEPU-SOWOD/t4/ft.yaml \
	OUTPUT_DIR training_dir/mepu-sowod/ss-t4-tf \
	MODEL.WEIGHTS training_dir/mepu-sowod/ss-t4-train/model_final.pth \
